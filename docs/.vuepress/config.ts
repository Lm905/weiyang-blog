...
const DOMAIN_NAME = 'weiyang.ink' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  // base: '/weiyang-blog/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    bodyBgImg: ['https://fastly.jsdelivr.net/gh/xugaoyi/image_store/blog/20200507175846.jpeg'],
    ...
    author: {
      name: 'weiyang', // 必需
      link: 'https://github.com/Lm905', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        ...
        'Wei Yang | <a href="https://beian.miit.gov.cn/" target="_blank">鲁ICP备2022014144号-1</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
